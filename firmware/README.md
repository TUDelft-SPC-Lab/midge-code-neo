...
a bit. After setting up zephyr RTOS (assuming you used `~/zephyrporject` as
installdir) you'll want to add a custom remote:
...
This custom remote is used to add chnages which are still not in mainline.
